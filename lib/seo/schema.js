...
export function generateOrganizationSchema() {
  return {
    ...
    description:
      'Sunshine Micro Lending is a Florida-licensed payday lender offering transparent short-term loans up to $500 to Florida residents, with fees capped by state law at 10% plus a $5 verification fee.',
    areaServed: {
      '@type': 'State',
      name: 'Florida',
    },
    ...
    hasCredential: {
      ...
      name: 'Deferred Presentment Provider License, Florida Office of Financial Regulation',
      identifier: '[LICENSE #]',
    },
  };
}
