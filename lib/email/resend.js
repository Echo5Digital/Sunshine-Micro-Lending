...
<body>
  ...
  <div class="wrapper">
    <div class="header">
      ...
      <p style="color: rgba(255,255,255,0.6); font-size: 12px; margin-top: 4px;">Florida Licensed Payday Lender</p>
    </div>
    <div class="content">
      ${content}
    </div>
    <div class="footer">
      <p>
        Sunshine Micro Lending | Florida Licensed Deferred Presentment Provider<br>
...
export async function sendApplicationEmail({
  ...
  const content = `
    ...
    <p>Hi ${firstName},</p>
    <p>Thank you for applying with ${COMPANY_NAME}. We have received your loan application and our team will review it shortly during business hours (Monday–Friday, 9AM–5PM EST).</p>
